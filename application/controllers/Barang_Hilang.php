...
class Barang_Hilang extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->db->where('tipe_posting', 'Barang Hilang');
		...
		$databarang['hilang'] = $this->M_beranda->getbarangKhusus('Barang Hilang', $config['per_page'], $databarang['page'], $databarang['urutkan'], $databarang['kata'], $databarang['kategori']);
