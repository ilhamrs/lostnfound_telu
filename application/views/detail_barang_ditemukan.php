            ...
            <ul id="side-menu" class="sidebar-menu">
                <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Beranda</a>
                    <ul>
                        ...
                        <li class="active"><a href="barang_ditemukan"><i class="icon-magnifier"></i> Barang
                                Ditemukan</a>
                        </li>
                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 mr-auto">
                            ...
                            <h1>Detail Barang Ditemukan</h1>
                        </div>

                        <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                            <li class="breadcrumb-item"><a href="home">Home</a></li>
                            <li class="breadcrumb-item"><a href="barang_hilang">Barang Ditemukan</a></li>
                            <li class="breadcrumb-item active">Detail Barang Ditemukan</li>
                        </ol>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="carouselExampleIndicators" class="carousel slide pointer-event" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="carousel-item">
                                                    <img class="d-block w-100" src="dist/images/cap1.jpg" alt="Third slide">
                                                </div>
                                            </div>
                                ...
                                <div class="col-12 col-sm-8">
                                    <form>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input disabled type="text" class="form-control" id="nama_barang" placeholder="Nama Barang">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="tanggal" class="col-sm-2 col-form-label">Tgl Ditemukan</label>
                                            <div class="col-sm-10">
                                                <input disabled type="date" class="form-control datepicker hasDatepicker" id="tanggal">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input disabled type="number" class="form-control" id="kontak" placeholder="081234567890">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="deskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
                                            <div class="col-sm-10">
                                                <textarea disabled name="deskripsi" id="deskripsi" cols="80" rows="5" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group row">
                                            <div class="col-sm-10">
