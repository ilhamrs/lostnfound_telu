                            ...
                            <div class="row row-cols-2">
                                ...
                                <div class="col-md-6 col-lg-3 mb-4">
                                    ...
                                    <div class="pt-3">
                                        ...
                                        <p class="mb-2" style="text-align: center;"><a
                                                href="detail_barang_ditemukan"
                                                class="font-weight-bold text-primary">Lihat Selengkapnya</a></p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3 mb-4">
                                ...
                                <div class="col-md-6 col-lg-3 mb-4">
                                    <div class="position-relative">
                                        <img src="dist/images/portfolio12.jpg" alt="" class="img-fluid">
                                        <div class="caption-bg bg-transparent text-right">
                                            <div class="d-table w-100 h-100 ">
                                                <div class="d-table-cell align-bottom">
                                                    <div class="mb-3">
                                ...
                                <div class="col-md-6 col-lg-3 mb-4">
                                    <div class="position-relative">
                                        <img src="dist/images/portfolio14.jpg" alt="" class="img-fluid">
                                        <div class="caption-bg bg-transparent text-right">
                                            <div class="d-table w-100 h-100 ">
                                                <div class="d-table-cell align-bottom">
                                                    <div class="mb-3">
                                ...
                                <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                                    <div class="position-relative">
                                        <img src="dist/images/portfolio18.jpg" alt="" class="img-fluid">
                                        <div class="caption-bg bg-transparent text-right">
                                            <div class="d-table w-100 h-100 ">
                                                <div class="d-table-cell align-bottom">
                                                    <div class="mb-3">
