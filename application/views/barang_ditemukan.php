        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        <div class="">
                            <form action="<?php echo base_url(); ?>Barang_Ditemukan/index/" method="POST">
                                <div class="form-row">
                        ...
                        <div class="row row-cols-2">
                            ...
                            <?php } ?>
                            <?php foreach ($ditemukan as $dataDitemukan) : ?>
                                <div class="col-md-6 col-lg-3 mb-4">
                                    <div class="position-relative">
                                        <img src="<?php echo base_url(); ?>dist/images/uploads/<?php echo $dataDitemukan['image1'] ?>" alt="" class="img-fluid">
                                        <div class="caption-bg bg-transparent text-right">
                                            <div class="d-table w-100 h-100 ">
                                                <div class="d-table-cell align-bottom">
                                                    <div class="mb-3">
                                                        <a href="#" class="rounded-left bg-white px-3 py-2 shadow2"><?php echo $dataDitemukan['tipe_posting']; ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pt-3">
                                        <div class="clearfix">
                                            <div class="">Nama Barang: <?php echo $dataDitemukan['nama_barang']; ?></div>
                                            <div class="">Lokasi: <?php echo $dataDitemukan['lokasi']; ?></div>
                                            <div class="">Tanggal: <?php echo $dataDitemukan['tgl_posting']; ?></div>

                                        </div>
                                        <p class="m-3" style="text-align: center;"><a href="<?php echo base_url(); ?>Detail_Barang/index/<?php echo $dataDitemukan['ID_posting'] ?>" class="font-weight-bold text-primary">Lihat Selengkapnya</a></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
